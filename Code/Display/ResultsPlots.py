...
def derivative_plot(feature, array, i_label, i_values, results_folder=None,
                    show=False, transparent=False):
    print(array.shape)
...
def one_d_plots(i_label, i_values, Dict, guesses, final_results_folder=None, show=False, transparent=False):
    ...
    derivative_plot('d|MFP|', GS_MF, i_label, i_values, final_results_folder, show, transparent)
